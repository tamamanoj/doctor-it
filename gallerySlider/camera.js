...
////////callbacks
		...
		onEndTransition		: function() { $(".camerarelative").addClass("add");  },	//this callback is invoked when the transition effect ends

		onLoaded			: function() { $(".camerarelative").addClass("add"); },	//this callback is invoked when the image on a slide has completely loaded
		
		onStartLoading		: function() { $(".camerarelative").addClass("add"); },	//this callback is invoked when the image on a slide start loading
		
		onStartTransition	: function() { $(".camerarelative").addClass("add");   }	//this callback is invoked when the transition effect starts
